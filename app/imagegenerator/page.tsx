  ...
  const handleGenerate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && data.result) {
        // Some Gemini responses might be base64 or a URL; for now we treat it as URL
        setImageUrl(data.result.trim());
      } else {
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-orange-50 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-pink-700 mb-2">AI Image Generator</h1>
          <p className="text-lg text-pink-600">Create stunning AI images from your descriptions</p>
        </div>
        ...
        {imageUrl && (
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h2 className="text-2xl font-semibold text-pink-700 mb-4">Generated Image</h2>
            <img src={imageUrl} alt="AI Generated" className="w-full rounded-lg border border-pink-100" />
        ...
        {!imageUrl && !isLoading && (
          <div className="bg-white rounded-xl shadow-lg p-6 mt-8">
            <h3 className="text-xl font-semibold text-pink-700 mb-3">Tips for better images</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-2">
              ...
              <li>Specify scene elements: e.g., "mountain landscape at sunrise with mist".</li>
            </ul>
          </div>
        )}
      </div>
