          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="mt-6 flex justify-between items-center">
              <p className="text-sm text-gray-500">
                Original: {inputText.split(/\s+/).length} words | Summary:{" "}
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="mt-6 p-4 bg-cyan-50 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                ...
                being explicitly programmed to perform a task, these systems use
                algorithms to identify patterns and make predictions or
                decisions based on data. The more data these systems are exposed
                to, the better they become at their designated tasks."
              </p>
            </div>
          </div>
        )}
